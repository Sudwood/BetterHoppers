			...
			for(int i = 0; i < slots.length; i++)
			{
				if(((ISidedInventory)tile).getStackInSlot(slots[i]) != null)
				{
					for(int ix = 0; ix < inventory.length; ix++)
					{
						...
						if(((ISidedInventory)tile).getStackInSlot(slots[i]) != null && inventory[ix].itemID == ((ISidedInventory)tile).getStackInSlot(slots[i]).itemID && inventory[ix].getItemDamage() == ((ISidedInventory)tile).getStackInSlot(slots[i]).getItemDamage())
						{
			...
			for(int i = 0; i < ((IInventory)tile).getSizeInventory(); i++)
			{
				if(((IInventory)tile).getStackInSlot(i) != null)
				{
					for(int ix = 0; ix < inventory.length; ix++)
					{
						...
						if(((IInventory)tile).getStackInSlot(i) != null && inventory[ix].itemID == ((IInventory)tile).getStackInSlot(i).itemID && inventory[ix].getItemDamage() == ((IInventory)tile).getStackInSlot(i).getItemDamage())
						{

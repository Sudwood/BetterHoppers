...
public class BlockBiggerHopper extends BlockHopper
{
    ...
    public BlockBiggerHopper(int par1)
    {
        super(par1);
    ...
    public void onEntityCollidedWithBlock(World par1World, int par2, int par3, int par4, Entity par5Entity) 
    {
    	...
    	{
    		boolean temp = false;
    		TileEntityBiggerHopper tile = (TileEntityBiggerHopper) par1World.getBlockTileEntity(par2, par3, par4);
    ...
    public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
    {
        ...
        {
            TileEntityBiggerHopper tileEntity = (com.sudwood.betterhoppers.tileentities.TileEntityBiggerHopper) par1World.getBlockTileEntity(par2, par3, par4);
            if (tileEntity != null)
            {
    ...
    {
        TileEntityBiggerHopper TileEntityBiggerHopper = (TileEntityBiggerHopper)par1World.getBlockTileEntity(par2, par3, par4);

        if (TileEntityBiggerHopper != null)
        {
            for (int j1 = 0; j1 < TileEntityBiggerHopper.getSizeInventory(); ++j1)
            {
                ItemStack itemstack = TileEntityBiggerHopper.getStackInSlot(j1);

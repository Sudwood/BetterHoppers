...
public class BlockStrongerHopper extends BlockHopper
{
    ...
    public BlockStrongerHopper(int par1)
    {
        super(par1);
    ...
    public void onEntityCollidedWithBlock(World par1World, int par2, int par3, int par4, Entity par5Entity) 
    {
    	...
    	{
    		boolean temp = false;
    		TileEntityStrongerHopper tile = (TileEntityStrongerHopper) par1World.getBlockTileEntity(par2, par3, par4);
    ...
    public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
    {
        ...
        {
            TileEntityStrongerHopper TileEntityStrongerHopper = (com.sudwood.betterhoppers.tileentities.TileEntityStrongerHopper) par1World.getBlockTileEntity(par2, par3, par4);

            if (TileEntityStrongerHopper != null)
            {
    ...
    {
        TileEntityStrongerHopper TileEntityStrongerHopper = (TileEntityStrongerHopper)par1World.getBlockTileEntity(par2, par3, par4);

        if (TileEntityStrongerHopper != null)
        {
            for (int j1 = 0; j1 < TileEntityStrongerHopper.getSizeInventory(); ++j1)
            {
                ItemStack itemstack = TileEntityStrongerHopper.getStackInSlot(j1);

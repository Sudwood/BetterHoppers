...
public class TileEntityFasterBiggerStrongerHopper extends TileEntityBiggerHopper implements IInventory
{
	public int numTransfered = 64;
	@Override
    public void updateEntity()
    {
     	if(!worldObj.isRemote && BlockBetterHopper.getIsBlockNotPoweredFromMetadata(this.blockMetadata))
     	{
	...
	public String getInvName() {
		return "Faster Bigger Stronger Hopper";
	}
